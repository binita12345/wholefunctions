...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CreateNewPrivateMessagePageModule", function() { return CreateNewPrivateMessagePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__create_new_private_message__ = __webpack_require__(493);
...
var CreateNewPrivateMessagePageModule = /** @class */ (function () {
    function CreateNewPrivateMessagePageModule() {
    }
    CreateNewPrivateMessagePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__create_new_private_message__["a" /* CreateNewPrivateMessagePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__create_new_private_message__["a" /* CreateNewPrivateMessagePage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_header_header_module__["a" /* HeaderComponentModule */]
            ],
        })
    ], CreateNewPrivateMessagePageModule);
    return CreateNewPrivateMessagePageModule;
}());

//# sourceMappingURL=create-new-private-message.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CreateNewPrivateMessagePage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_lodash__ = __webpack_require__(494);
 ...
 */
var CreateNewPrivateMessagePage = /** @class */ (function () {
    function CreateNewPrivateMessagePage(navCtrl, navParams, modalCtrl, plt, fileChooser, filePicker, filePath, file, base64, viewCtrl, alertCtrl, _sanitizer, storage, loader, serviceProvider) {
    ...
    CreateNewPrivateMessagePage.prototype.ionViewDidLoad = function () {
        var _this = this;
    ...
    CreateNewPrivateMessagePage.prototype.removeSelectedUser = function (id) {
        console.log("remove selected user");
        console.log("remove data selected", id);
        this.usersUniqArr = this.usersUniqArr.filter(function (item) { return item.id !== id; });
        // console.log("this.usersUniqArr remove", this.usersUniqArr);
        console.log("remove this.usersUniqArr", this.usersUniqArr);
        Array.prototype.map.call(this.usersUniqArr, function (s) { return s.id; }).toString(); // "A,B,C"
        this.userString = Array.prototype.map.call(this.usersUniqArr, function (s) { return s.id; }).toString();
    ...
    CreateNewPrivateMessagePage.prototype.createUserToSendMessage = function () {
        var _this = this;
        console.log("create user to send message");
        var searchUserModal = this.modalCtrl.create("SearchUserToMessagePage", {}, { showBackdrop: true, enableBackdropDismiss: true });
        searchUserModal.present();
        searchUserModal.onDidDismiss(function (data) {
            ...
            if (data == undefined) {
                ...
                if (data.profile_picture !== '' || data.profile_picture !== null) {
                    _this.image = data.profile_picture;
                }
                else {
                    _this.image = '';
                }
                _this.id = data.id;
                _this.name = data.first_name + ' ' + data.last_name;
                console.log("this.name", _this.name);
                _this.designation = data.current_position;
                _this.ifData = true;
                _this.usersArr.push({ 'image': _this.image, 'id': _this.id, 'name': _this.name, 'position': _this.designation });
                var uniqueArr = [];
                uniqueArr = __WEBPACK_IMPORTED_MODULE_9_lodash__["uniqWith"](_this.usersArr, __WEBPACK_IMPORTED_MODULE_9_lodash__["isEqual"]);
                _this.usersUniqArr = uniqueArr;
                console.log("data this.usersUniqArr", _this.usersUniqArr);
                Array.prototype.map.call(_this.usersUniqArr, function (s) { return s.id; }).toString(); // "A,B,C"
                _this.userString = Array.prototype.map.call(_this.usersUniqArr, function (s) { return s.id; }).toString();
            }
        });
    };
    CreateNewPrivateMessagePage.prototype.addImageORFileToPrivate = function () {
        var _this = this;
    ...
    CreateNewPrivateMessagePage.prototype.cancelNewMessage = function () {
        console.log("cancel new message");
        this.viewCtrl.dismiss();
    };
    CreateNewPrivateMessagePage.prototype.htmlProperty = function () {
        return this._sanitizer.bypassSecurityTrustHtml(this._htmlProperty);
    };
    CreateNewPrivateMessagePage.prototype.saveNewMessage = function () {
    ...
    CreateNewPrivateMessagePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-create-new-private-message',template:/*ion-inline-start:"/Volumes/mac_data/Document_data/Binita/hoscom/HosComApp/src/pages/create-new-private-message/create-new-private-message.html"*/'<!--\n  Generated template for the CreateNewPrivateMessagePage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<header title="Newsfeed"> </header>\n\n<ion-content class="paddingTop">\n	<ion-item class="divCss">\n		<ion-icon name="md-arrow-round-back" class="iconCss" item-start navPop></ion-icon>\n		<p class="pCss">Create Message</p>\n	</ion-item>\n\n	<ion-grid class="gridCss">\n		<p class="headP">New Message</p>\n		<ion-row>\n\n			<ion-item class="createItem" *ngIf="!ifData">\n				<p item-start>To:</p>\n				<img src="assets/imgs/newsfeed/createMessage.png" class="createImg" item-start (click)="createUserToSendMessage()">\n			</ion-item>\n\n			<ion-item class="createItem" *ngIf="ifData">\n       	<p item-start>To:</p>\n       		<div *ngFor="let user of usersUniqArr">\n		       	<div class="main_photo">\n		          <img src="assets/imgs/newsfeed/close2.png" class="editIcon inlay" (click)="removeSelectedUser(user.id)"/>\n		          <img src="{{user.image}}" class="image" (click)="createUserToSendMessage()">\n		        </div>\n		        <p class="userNameC">{{user.name}}</p>\n		        <p class="desigC">{{user.position}}</p>\n	        </div>\n			</ion-item>\n\n			<ion-col col-6 col-xl-6 class="headlineC">\n				<ion-item class="drpItem">\n					<ion-input type="text" class="ionInput" [(ngModel)]="headline" placeholder="Headline"></ion-input>\n				</ion-item>\n			</ion-col>\n			<ion-col col-6 col-xl-6>\n				<button ion-button round outline class="imageBtn" (click)="addImageORFileToPrivate()">ADD IMAGE OR FILE</button>\n			</ion-col>\n			<ion-col>\n				<ion-textarea placeholder="Your Message" class="textArea" [(ngModel)]="message"></ion-textarea>\n			</ion-col>\n		</ion-row>\n\n		<ion-item class="lastBtns">\n	    	<button ion-button round class="cancelBtn" (click)="cancelNewMessage()" item-end>CANCEL</button>\n			<button ion-button round class="postBtn" (click)="saveNewMessage()" item-end>SEND</button>\n	  </ion-item>\n		\n	</ion-grid>\n	<div style="margin-top: 45px;height: 20px;"></div>\n</ion-content>\n'/*ion-inline-end:"/Volumes/mac_data/Document_data/Binita/hoscom/HosComApp/src/pages/create-new-private-message/create-new-private-message.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* ModalController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Platform */], __WEBPACK_IMPORTED_MODULE_2__ionic_native_file_chooser__["a" /* FileChooser */],
            ...
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */], __WEBPACK_IMPORTED_MODULE_7__angular_platform_browser__["c" /* DomSanitizer */], __WEBPACK_IMPORTED_MODULE_8__ionic_storage__["b" /* Storage */], __WEBPACK_IMPORTED_MODULE_10__providers_loader_loader__["a" /* Loader */], __WEBPACK_IMPORTED_MODULE_11__providers_service_service__["a" /* ServiceProvider */]])
    ], CreateNewPrivateMessagePage);
    return CreateNewPrivateMessagePage;
}());

//# sourceMappingURL=create-new-private-message.js.map
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(55), __webpack_require__(352)(module)))
